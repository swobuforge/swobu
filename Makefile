...
lint:
	...
	@cd ../tools && CGO_ENABLED=0 $(GO) run ./cmd/rolelint github.com/swobuforge/swobu/internal/...
	@cd ../tools && CGO_ENABLED=0 $(GO) run ./cmd/codelint github.com/swobuforge/swobu/internal/...
	@cd ../tools && CGO_ENABLED=0 $(GO) run ./cmd/trimlowerlint github.com/swobuforge/swobu/internal/...
