...
// exchange.
//
// It composes typed ports, links, predicates, middleware, runtime codec lookup,
...
// state; exchange may materialize or clear native continuation, but it does not
// redefine the tool ontology or embed provider-specific tool behavior.
