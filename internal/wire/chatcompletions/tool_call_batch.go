...
func encodeChatCompletionsToolCallBatch(payload map[string]any, policy canonical.ToolCallBatchPolicy, hasTools bool, rejectsFalse func() bool, changeLog *[]compat.Change) error {
	if policy.IsZero() {
		return nil
	}
