...
// TokenUsage records provider-neutral token counters in traffic evidence.
...
// emission time.
// TODO: De-duplicate with canonical.TokenUsage. Both types share identical
// structure and behavior. Merging requires updating TrafficEventInput and
// all constructor call sites in the trafficevidence bounded context.
// Task frame needed before structural merge. See tracing:dupl-high-threshold.
