...
// PanelBorderStyle defines the border glyphs used when rendering a transcript
// panel.
...
// PanelSpec describes one bordered durable transcript block.
...
// DurablePanel builds one durable transcript panel node.
