...
// RenderMode selects how a renderer projects a transcript tree to terminal output.
...
// ViewSpec is the shared declarative terminal transcript tree for
// line-oriented rendering strategies.
