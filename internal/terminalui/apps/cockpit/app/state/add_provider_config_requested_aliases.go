...
type SetCreateDraftAuthHeaderAction = stateIntent.SetCreateDraftAuthHeaderAction
...
type SetSelectedClientID = stateIntent.SetSelectedClientID
type SetFocusedRowAffordance = stateIntent.SetFocusedRowAffordance
type SetTrafficSectionOffset = stateIntent.SetTrafficSectionOffset
type ToggleTrafficRowOpen = stateIntent.ToggleTrafficRowOpen
type ToggleSectionOpen = stateIntent.ToggleSectionOpen
type SetWorkspaceEditing = stateIntent.SetWorkspaceEditing
type SetWorkspaceDraft = stateIntent.SetWorkspaceDraft
type SetWorkspaceErrMsg = stateIntent.SetWorkspaceErrMsg
type SetClientPickerOpen = stateIntent.SetClientPickerOpen
type SetClientPickerCursor = stateIntent.SetClientPickerCursor
type ToggleExpandedActionID = stateIntent.ToggleExpandedActionID
type SetPayloadScrollOffset = stateIntent.SetPayloadScrollOffset
...
type MismatchRestartRequested = stateIntent.MismatchRestartRequested
type ExchangeDiagnosticsCopyRequested = stateIntent.ExchangeDiagnosticsCopyRequested
