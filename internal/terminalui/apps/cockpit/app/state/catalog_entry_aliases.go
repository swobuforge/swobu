...
type ModelSelectionReadinessGateInput = stateModel.ModelSelectionReadinessGateInput
type ModelSelectionGateState = stateModel.ModelSelectionGateState
type ModelSelectionBlockReason = stateModel.ModelSelectionBlockReason

var EvaluateModelSelectionGateState = stateModel.EvaluateModelSelectionGateState
