...
func (e ResponseStreamEncoder) EncodeResponseStream(events canonical.EventReader, _ delivery.Delivery) (carrier.WireStream, error) {
	...
	return carrier.WireStream{Stage: carrier.StageClientResponseOut, Family: protocolkind.Messages, Framing: carrier.FramingSSE, Frames: carrier.FrameReaderFromReadCloser(pr)}, nil
}
