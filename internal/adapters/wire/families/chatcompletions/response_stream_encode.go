...
func (e ResponseStreamEncoder) EncodeResponseStream(events canonical.EventReader, _ delivery.Delivery) (exchange.Result[carrier.WireStream], error) {
	...
	return exchange.NewResult(carrier.WireStream{Stage: carrier.StageClientResponseOut, Family: protocolkind.ChatCompletions, Framing: carrier.FramingSSE, Frames: carrier.FrameReaderFromReadCloser(pr)}), nil
}
