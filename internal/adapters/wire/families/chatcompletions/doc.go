...
// provides it. Empty tool surfaces omit tool_choice because the choice is
// inert there and some backends reject an explicit no-tool field. It must not
// take on endpoint selection, provider wiring, or non-chat public contract
// semantics. Client request decoding also normalizes stringified
// function_call.arguments payloads emitted by OpenCode-style client bridges.
