...
func (ClientDocumentEncoder) EncodeClientDocument(output canonical.CanonicalOutput) (carrier.WireDocument, error) {
	...
	return carrier.WireDocument{Family: protocolkind.Responses, Media: "application/json", Raw: encodedBody}, nil
}
...
func (e ClientStreamEncoder) EncodeClientStream(events canonical.EventReader) (carrier.WireStream, error) {
	...
	return carrier.WireStream{Family: protocolkind.Responses, Framing: carrier.FramingSSE, Frames: carrier.FrameReaderFromReadCloser(pr)}, nil
}
...
func (ProviderRequestEncoder) EncodeProviderRequestWithOptions(request canonical.CanonicalRequest, delivery delivery.Delivery, options EncodeOptions) (carrier.WireDocument, error) {
	return encodeRequestCarrierWithOptions(request, delivery, options)
}
