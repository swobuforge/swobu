...
func Encode(req canonical.CanonicalRequest, deliveryMode bool) (core.WireRequest, error) {
	...
	case false, true:
	default:
		return core.WireRequest{}, canonical.UnsupportedDelivery("conversation requests do not implement the requested delivery variant on the messages protocol")
	}
	...
	if err != nil {
		return core.WireRequest{}, canonical.BadRequest("conversation request could not be encoded for the messages protocol")
	}
