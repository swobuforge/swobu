...
func encodeRequest(request canonical.CanonicalRequest, deliveryMode bool) (core.WireRequest, error) {
	...
	if len(thread) == 0 {
		return core.WireRequest{}, canonical.BadRequest("request does not contain replayable conversation input")
	}
...
func Encode(req canonical.CanonicalRequest, deliveryMode bool) (core.WireRequest, error) {
	...
	case false, true:
	default:
		return core.WireRequest{}, canonical.UnsupportedDelivery("conversation requests do not implement the requested delivery variant on the chat completions protocol")
	}
	...
	if err != nil {
		return core.WireRequest{}, canonical.BadRequest("conversation request could not be encoded for the chat completions protocol")
	}
