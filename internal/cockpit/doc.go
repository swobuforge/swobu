...
//
// It is the canonical go-tui interactive entrypoint. It owns workspace
// navigation, route and target inspection, inline editing workflows, and
// activity review. It does not own daemon lifecycle commands, telemetry
// disclosure, or transcript-mode output.
//
