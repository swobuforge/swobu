...
func (c *ConfirmationView) Render(app *tui.App) *tui.Element {
	__tui_0 := tui.New(
		tui.WithDisplay(tui.DisplayFlex), tui.WithDirection(tui.Column),
		tui.WithWidthPercent(100.00),
	)
	__tui_1 := app.Mount(c, 0, func() tui.Component {
		return ConfirmationRowComponent(c)
	})
...
func (c *ConfirmationView) updatePropsFields(fresh tui.Component) {
	f, ok := fresh.(*ConfirmationView)
	if !ok {
		return
	}
...
func (c *ConfirmationView) UpdateProps(fresh tui.Component) {
	c.updatePropsFields(fresh)
}

var _ tui.PropsUpdater = (*ConfirmationView)(nil)
...
func (c *ConfirmationView) bindAppFields(app *tui.App) {
	if c.PendingDeleteWorkspaceID != nil {
		c.PendingDeleteWorkspaceID.BindApp(app)
	}
}

func (c *ConfirmationView) BindApp(app *tui.App) {
	c.bindAppFields(app)
}

var _ tui.AppBinder = (*ConfirmationView)(nil)

// Compile-time interface satisfaction checks.
var (
	_ tui.KeyListener = (*ConfirmationView)(nil)
)
