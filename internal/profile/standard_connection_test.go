...
func TestCatalogProfileSemanticFieldsFailClosed(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"optional ambient or reference", CredentialSpec{Requirement: CredentialOptional, Authoring: CredentialAuthoringAmbientOrReference, AmbientLabel: "ambient", ReferenceLabel: "key"}, true},
		{"ambient missing labels", CredentialSpec{Requirement: CredentialOptional, Authoring: CredentialAuthoringAmbientOrReference}, false},
		{"reference with ambient labels", CredentialSpec{Requirement: CredentialOptional, Authoring: CredentialAuthoringReference, AmbientLabel: "ambient", ReferenceLabel: "key"}, false},
